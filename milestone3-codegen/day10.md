...
Define a new builder strategy `generate-jc`, that generates the Jasmin file and turns it into a Java class file. To generate the class file, you first need to generate the Jasmin AST.  
